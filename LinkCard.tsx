      ...
      >
        ...
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <div className="flex-1 min-w-0 overflow-hidden">
            <h3 className="font-bold text-slate-800 dark:text-slate-100 truncate text-xs leading-none group-hover:text-purple-600 dark:group-hover:text-neon-blue transition-colors">
              {item.title}
            </h3>
